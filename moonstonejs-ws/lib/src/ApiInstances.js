...
var MoonstoneApi = require("./MoonstoneApi");
...
/**
    ...
    Import: import { Apis } from "@moonstone/chain"
...
class ApisInstance {
    ...
    connect( cs ) {
        ...
        this.init_promise = this.ws_rpc.login(rpc_user, rpc_password).then(() => {
            ...
            this._db = new MoonstoneApi(this.ws_rpc, "database");
            this._net = new MoonstoneApi(this.ws_rpc, "network_broadcast");
            this._hist = new MoonstoneApi(this.ws_rpc, "history");
            this._crypt = new MoonstoneApi(this.ws_rpc, "crypto");
