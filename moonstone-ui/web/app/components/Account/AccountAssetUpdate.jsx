...
import {SmartAssetOptions} from "./AccountAssetCreate";
...
class AccountAssetUpdate extends React.Component {
    ...
    resetState(props) {
        ...
        let isSmartAsset = asset.smartasset_data_id !== undefined;
        ...
        console.log("isSmartAsset:", isSmartAsset);

        let flagBooleans = assetUtils.getFlagBooleans(asset.options.flags, isSmartAsset);
        let permissionBooleans = assetUtils.getFlagBooleans(asset.options.issuer_permissions, isSmartAsset);
        ...
        return {
            ...
            fundPoolAmount: 0,
            claimFeesAmount: 0,
            smartasset_opts: isSmartAsset ? asset.smartasset.options : null,
            original_smartasset_opts: isSmartAsset ? props.asset.getIn(["smartasset", "options"]).toJS() : null,
            marketInput: ""
        };
    }
    ...
    _updateAsset(e) {
        ...
        let {update, issuer, new_issuer_account, core_exchange_rate, flagBooleans,
            permissionBooleans, isSmartAsset, smartasset_opts, original_smartasset_opts} = this.state;
        ...
        AssetActions.updateAsset(issuer, new_issuer_account, update, core_exchange_rate, this.props.asset,
            flags, permissions, isSmartAsset, smartasset_opts, original_smartasset_opts, description).then(result => {
    ...
    onChangeSmartAssetOpts(value, e) {
        ...
        switch (value) {
            ...
            default:
                smartasset_opts[value] = parseInt(e.target.value, 10);
                break;
        }
    ...
    render() {
        ...
        let {errors, isValid, update, assets, core_exchange_rate, flagBooleans,
            permissionBooleans, fundPoolAmount, claimFeesAmount, isSmartAsset, smartasset_opts} = this.state;
        ...
        let originalPermissions = assetUtils.getFlagBooleans(asset.getIn(["options", "issuer_permissions"]), asset.get("smartasset") !== undefined);
        ...
        let isPredictionMarketAsset = asset.getIn(["smartasset", "is_prediction_market"]);
