...
Moonstone > $g.db.api.exec("get_objects",[["1.2.0"]])
var o=_[0]
o.active
...
Moonstone > $g.db.api.exec("get_objects",[["1.2.15"]])
var o=_[0]
o.active
...
Moonstone > var tr = $g.wallet.new_transaction()
Moonstone > tr.add_type_operation("account_upgrade", {"account_to_upgrade":"1.2.15","upgrade_to_lifetime_member":true})
Moonstone > $g.wallet.sign_and_broadcast(tr)
null
...
var trx = ["asset_update_smartasset", {"issuer":"1.2.15","asset_to_update":"1.3.1","new_options":{"feed_lifetime_sec":55,"force_settlement_delay_sec":0,"force_settlement_offset_percent":0,"maximum_force_settlement_volume":0,"short_backing_asset":"1.3.0"}}]
