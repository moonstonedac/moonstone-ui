...
module.exports = function(options) {
    ...
    var plugins = [
        ...
        new webpack.DefinePlugin({
            APP_VERSION: JSON.stringify("Moonstone DAC 1.00")
        })
    ];
    ...
    var config = {
        ...
        module: {
            loaders: [
                {
                    test: /\.jsx$/,
                    include: [path.join(root_dir, "app"), path.join(root_dir, "node_modules/react-foundation-apps"), "/home/sigve/Dev/moonstone/react-foundation-apps"],
