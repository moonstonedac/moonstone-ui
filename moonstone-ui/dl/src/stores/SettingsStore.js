...
const CORE_ASSET = "XMS"; // Setting this to BTS to prevent loading issues when used with BTS chain which is the most usual case currently

const STORAGE_KEY = "__moonstone__";
...
class SettingsStore {
    constructor() {
        ...
        this.defaultSettings = Immutable.Map({
            locale: "en",
            apiServer: "wss://node.moonstonedac.com",
            faucet_address: "http://faucet.moonstonedac.com:3000",
            unit: CORE_ASSET,
            showSettles: false,
        ...
        let apiServer = [
            {url: "wss://node.moonstonedac.com", location: "WSS"},
        ];
