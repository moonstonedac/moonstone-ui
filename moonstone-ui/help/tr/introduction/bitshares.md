...
Daha önce bahsedildiği gibi , Moonstone sadece bir *teknolojiyi* yada *protokolü* 
tarif etmektedir. Fakat fiilen bir  ekosisteme dönüşmesi  Moonstone gibi 
gerçek bir blokzinciri ile birlikte mümkün olur.

Moonstone , blokzinciri yeniliğini , hizmetlerini internet kullanarak sunan tüm 
...
Bitcoin para için ne yaptıysa Moonstone'de işletmeler için onu yapar. Bunu , evrensel, 
şeffaf, güvenilir, verimli ve karlı şirketler yaratmak için dağıtık mutabakat teknolojisini 
kullanarak yapar.

## Bu Cüzdan

Şu an bu tarayıcı penceresinde açık olan cüzdanla Moonstone ağının tüm işlevlerine
erişebilirsiniz.
