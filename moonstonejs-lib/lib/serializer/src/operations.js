...
var asset_update_smartasset_operation_fee_parameters = new Serializer( 
    "asset_update_smartasset_operation_fee_parameters",
    {fee: uint64}
);
...
var smartasset_options = new Serializer( 
    "smartasset_options",
...
var asset_create = new Serializer( 
    ...
    smartasset_opts: optional(smartasset_options),
...
var asset_update_smartasset = new Serializer( 
    "asset_update_smartasset",
    {fee: asset,
    issuer: protocol_id_type("account"),
    asset_to_update: protocol_id_type("asset"),
    new_options: smartasset_options,
    extensions: set(future_extensions)}
);
