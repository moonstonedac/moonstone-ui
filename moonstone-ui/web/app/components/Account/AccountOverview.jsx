...
class AccountOverview extends React.Component {
    ...
    _renderBalances(balanceList) {
        ...
        balanceList.forEach( balance => {
            ...
            let isSmartAsset = asset && asset.has("smartasset_data_id");
            ...
            balances.push(
                <tr key={balance} style={{maxWidth: "100rem", backgroundColor: !includeAsset ? "#3E3E3E" : null}}>
                    {/*isSmartAsset ? <td><div onClick={this._onSettleAsset.bind(this, asset.get("id"))} className="button outline"><Translate content="account.settle" /></div></td> : <td></td>*/}
